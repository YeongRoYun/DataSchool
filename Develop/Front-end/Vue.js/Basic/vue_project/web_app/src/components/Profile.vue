            ...
            <div class="col-sm-2 text-center flex-column d-none d-sm-flex">
                ...
                <h1>
                    <span
                        ...
                        :class="[!index ? 'bg-primary text-light' : 'bg-light text-dark']">{{ new Date(d.date).getFullYear()}}</span>
                </h1>
                <div class="row h-50">
                    <div
                        class="col"
        ...
        <div v-if="show" class="col-sm py-2">
            <div class="card" :class="{'border-primary bg-primary text-light': top, shadow: top }">
                <div class="card-body">
                    ...
                    <a v-if="resume.URL != ''" :href="resume.URL" target="_blank" :class="[top ? 'text-light' : 'text-primary']">link</a>
                </div>
            </div>
        </div>
